...
app = Chalice(app_name='BlackScholes_option_bot_alert')

token_path = os.path.join(os.path.dirname(__file__), 'chalicelib', 'token') # Creates token and authorizes
...
# Function to send order to webhooks api
